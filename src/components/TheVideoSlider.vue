...
const sliders = [
  {
    quote:
      '«Skyfort открывает доступ к глобальной инфраструктуре, ранее доступной лишь крупным институционалам и ультрабогатым семьям»',
    author: 'Илья Опренко, Co-founder & CEO'
  },
  {
    quote:
      '«Мы объединяем управляющих капиталом, инвесторов и поставщиков качественных инвестиционных продуктов и сервисов по всему миру»',
    author: 'Сергей Ишков, Co-founder & COO/CFO'
  },
  {
    quote:
      '«Чтобы стать надежной безопасной гаванью для владельцев капитала, мы стремимся занять позицию выше хаоса и диверсифицировать риски»',
    author: 'Илья Опренко, Co-founder & CEO'
  },
  {
    quote:
      '«Наша задача - агрегировать лучшие мировые практики управления крупным капиталом и сделать их доступными более широкому кругу лиц»',
