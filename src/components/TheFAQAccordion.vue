...
const items = [
  ...
  },
  {
    ...
    body: 'ообщество Skyfort - это профессиональная ассоциация ведущих экспертов в области wealth management и private banking. Наша миссия - способствовать формированию нового класса независимых управляющих капиталом и финансовых советников в России и за рубежом, помогать банкирам и финансовым консультантам создавать и развивать собственный бизнес. Для подачи заявки на раннее участие пишите в Telegrm <a href="https://t.me/harrybright" target="_blank">@harrybright</a>.'
  }
]
</script>
