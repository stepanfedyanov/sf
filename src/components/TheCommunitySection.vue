...
const staff = [
  ...
  },
  {
    ...
    name: 'Андрей Тынков',
    position: 'Старший банкир',
    desc: '15+ лет опыта в индустрии управления капиталом и инвестиционно-банковских услуг. Более более 12 лет руководил российскими отделениями Citibank по работе с состоятельными клиентами. Ведет клиентов мультисемейного офиса как личный банкир.',
    href: '',
  },
  {
